...
PHASES = {
    ...
    # MELLO EP003, three minutes, every shot a generated clip.
    "mello3-setup": "sets the moving episode up",
    "mello3-type": "types the twenty-eight moving beats",
    "mello3-draw": "draws the twenty-eight start frames",
    "mello3-restill": "re-draws the stills that failed",
    "mello3-approve": "approves the start frames",
    "mello3-animate": "hands each approved still to image-to-video",
    "mello3-clips": "generates the twenty-eight clips",
    "mello3-reclip": "re-draws the clips that lost the character",
    "mello3-render": "cuts and renders the moving episode",
